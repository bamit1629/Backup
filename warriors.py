...
def send_welcome(message):
    ...
    btn7 = KeyboardButton("User Commands✔️")
    btn7 = KeyboardButton("Admin Commands✔️")

    # Add buttons to the markup
    markup.add(btn1, btn2, btn3, btn4, btn5, btn6)

    bot.send_message(message.chat.id, "*Welcome to WarriorsLab*", reply_markup=markup, parse_mode='Markdown')
