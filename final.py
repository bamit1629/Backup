...
def handle_message(message):
    if message.text == "Testing Plan 🧡":
        bot.reply_to(message,"*1D-->130*",
            parse_mode = 'Markdown')
        bot.reply_to(message,"*3D-->360*",
            parse_mode = 'Markdown')
        bot.reply_to(message,"*7D --> 600*", parse_mode = 'Markdown')
    elif message.text == "Premium Plan 💥":
        bot.reply_to(message, "*15D --> 950*",parse_mode='Markdown')
        bot.reply_to(message, "*30D --> 1500*",parse_mode='Markdown')
        bot.reply_to(message, "*60D --> 2200*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact with @Warriors_King & @Iconic_Hack*", parse_mode='Markdown')
